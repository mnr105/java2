...
public class cCompania {
	...
	public bActiune getActiune() {
		return actiune;
	}

	public void setActiune(bActiune actiune) {
		this.actiune = actiune;
	}

	public cCompania(Long id, bActiune actiune, String nume, String tara,
	...
	public cCompania(bActiune actiune, String nume, String tara,
			String simbolPiataCapital, double capitalPropiu,
			double capitalSocial, double profitNetTrimestrial,
			int numarAngajati, double pofitNetRepartizat, Date ipo,
			int nrActIpo, double pretActIpo, List<Date> alteEmisiuni,
