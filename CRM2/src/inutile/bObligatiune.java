...
public class bObligatiune {
	...
	public bObligatiune(Long idInstr, cPortofoliu portofoliu,
			...
			float rataNominalaAnuala, boolean convertibilitate) {
		super();
		this.idInstr = idInstr;
		this.portofoliu = portofoliu;
		this.tipInstument = tipInstument;
	...
	public bObligatiune(cPortofoliu portofoliu, String tipInstument,
			...
			double prima, String stragetie, float rataNominalaAnuala,
			boolean convertibilitate) {
		super();
		this.portofoliu = portofoliu;
		this.tipInstument = tipInstument;
		this.unitateMasura = unitateMasura;
